package com.example.sd_41.controller.Admin.MauSac;
...
//
//        // Tạo danh sách các trang để hiển thị ở giao diện
...
//    @RequestMapping(value = "/MauSac/list", method = RequestMethod.GET)
