...
import com.example.sd_41.service.ChuonTrinhGiamGiaChiTietHoaDonService;
...
public class ChuonTrinhGiamGiaHoaDonController {
    @Autowired
    private ChuongTrinhGiamGiaHoaDonService serviceHD;

    @Autowired
    private ChuonTrinhGiamGiaChiTietHoaDonService serviceCTHD;
