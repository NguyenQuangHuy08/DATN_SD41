        ...
        <c:forEach var="phieuGiaoHang" items="${listPage}" varStatus="i">
            <tr class="product-item hide-row">
                ...
                <td style="margin-bottom: 10px">
                    <a class="col-sm-4" href="${pageContext.request.contextPath}/PhieuGiaoHang/update/${phieuGiaoHang.id}"><button class="btn btn-primary" style="margin-left: 30px;float: left; margin-top: 24px">Edit</button></a>
                    <a class="col-sm-4" href="${pageContext.request.contextPath}/PhieuGiaoHang/update/${phieuGiaoHang.id}"><button class="btn btn-primary">Detail</button></a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
