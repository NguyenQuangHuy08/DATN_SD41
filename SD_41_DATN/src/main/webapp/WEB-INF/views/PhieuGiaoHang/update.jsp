...
<section class="scrollable-list" style="width: 100%; max-height: 700px; overflow-y: auto; overflow-x: hidden">
  <div class="container">
      ...
      <h4 style="color: red; font-weight: bold;font-size: 20px; margin-bottom: 30px">${messDoneUpdate}</h4>
              <form action="/PhieuGiaoHang/update/${phieuGiaoHang.id}" method="POST">

                  <input type="text" hidden name="id" value="${phieuGiaoHang.id}">
                  ...
                  <div class="form-row">
                      ...
                      <div class="form-group col-md-4">
                          ...
                          <select  class="form-control" name="hoaDon.id">
                              <c:forEach items="${hoaDon}" var="chatLieu">
                  ...
                  <div class="form-row">
                      <div class="form-group col-md-4">
                          ...
                          <input type="text" class="form-control"  placeholder="Tên người nhận" name="tenNguoiNhan" value="${phieuGiaoHang.tenNguoiNhan}">
                          <div class="er">
                      ...
                      <div class="form-group col-md-4">
                          ...
                          <input id="phiShip" onblur="formatPhiShip()" type="text" class="form-control"  placeholder="Phí Ship" name="phiShip" value="${phieuGiaoHang.phiShip}">
                          <div class="er">
