    ...
    <section class="row">
      ...
      <div class="col-9 promotion">
        <div class="btn-function">
          ...
          <div>
            <a href="${pageContext.request.contextPath}/chuongTrinhGiamGia/${link}/createForm" class="btn btn-success"
              ><i class="fa fa-plus" style="color: #ffffff"></i> Chương trình
              khuyến mại
            </a>
            <a href="${pageContext.request.contextPath}/chuongTrinhGiamGia/${link}/history" class="btn btn-primary">Lịch sử</a>
          </div>
        </div>
