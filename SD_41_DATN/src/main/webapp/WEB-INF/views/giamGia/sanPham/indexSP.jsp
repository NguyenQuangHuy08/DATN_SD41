            ...
            <c:if test="${f:length(list.getContent())!=0}">
              ...
              >
                <tr class="${gg.id}">
                  ...
                  <td>
                    <a href="${pageContext.request.contextPath}/chuongTrinhGiamGia/${link}/apply?id=${gg.id}" class="btn btn-primary">Áp dụng</a>
                    <a href="${pageContext.request.contextPath}/chuongTrinhGiamGia/${link}/detail?id=${gg.id}" class="btn btn-info">Chi tiết</a>
                    <a
