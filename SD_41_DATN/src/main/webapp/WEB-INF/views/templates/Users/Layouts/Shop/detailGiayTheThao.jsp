...
<%--                            Check số lượng--%>
                    ...
                    <p>${giayTheThao1.giaBan}</p>


                <%--                    <input type="" name="idKhachHang" value="${idKhachHang}">--%>
<%--                    <input type="" name="idGiayTheThaoChiTiet" value="${idGiayTheThaoChiTiet}">--%>
                    <input type="" name="giaBan" value="giayTheThao.giaBan">
