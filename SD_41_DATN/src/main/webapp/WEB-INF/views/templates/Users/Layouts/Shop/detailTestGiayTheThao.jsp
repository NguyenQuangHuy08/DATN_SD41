...
<%--                <h6 style="color: black;margin-top: 30px">--%>
<%--                    Giá bán: ${giayTheThao.giaBan} VNĐ--%>
<%--                </h6>--%>
...
<%--                                            <input style="margin-left: 20px" type="radio" name="size" value="${size.id}" id="size-${size.id}">--%>
<%--                                            ${size.size}--%>
<%--                                        </c:forEach>--%>
<%--                                        <br>--%>
<%--                                    </span>--%>
...
<%--                                        <input style="margin-left: 20px" type="radio" name="mauSac" value="${mauSac.id}" id="mauSac-${mauSac.id}">--%>
<%--                                        ${mauSac.tenMauSac}--%>
<%--                                    </c:forEach>--%>
<%--                                </span>--%>
<%--                            </div>--%>
...
<%--                                <span style="margin-left: 30px; font-size: 17px; color: black">${totalSoLuong} sản phẩm sẵn có</span>--%>
<%--                            </div>--%>
<%--                        </div>--%>
<%--                    </div>--%>
